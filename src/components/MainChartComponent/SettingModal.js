...
const SettingModal = (props) => {
    ...
    return (
        <div className="btn-group dropup anim-sound-setting">
            <InfoBox className='relative' outSideClickFunc={setShowAnimation}>
                <a type="button" className="btn btn-secondary bg-transparent border-0 shadow-none p-0"
                ...
                <div className={`absolute prevent-drop timeline-bg ${showAnimation ? 'show' : 'hidden'}`}>
                    <div className="animation-content">                    
                        <h6 className="title">Animation</h6>
                        <RadioButtons values={AnimationType}></RadioButtons>
                    </div>
                    <div className="sound-content">
                        <h6 className="title">Sound</h6>

                        <div className="sound-settings">
                            <table>
                                <tr>
                                    <td className="setting-title">Take Off</td>
                                    <td className="setting-checkbox">
                                        <label className="check-setting">
                                            <input name="takeOff" onChange={changeSoundSetting} checked={soundSettings.takeOff} type="checkbox"/>
                                            <span></span>
                                        </label>
                                    ...
                                    <td>
                                        {
                                            soundSettings.takeOff ? 'On' : 'Off'
                                        }
                                    </td>
                                </tr>
                                <tr>
                                    <td className="setting-title">Cruise</td>
                                    <td className="setting-checkbox">
                                        <label className="check-setting">
                                            <input name="cruise" onChange={changeSoundSetting} checked={soundSettings.cruise} type="checkbox"/>
                                            <span></span>
                                        </label>
                                    ...
                                    <td>
                                        {
                                            soundSettings.cruise ? 'On' : 'Off'
                                        }
                                    </td>
                                </tr>
                                <tr>
                                    <td className="setting-title">Bet Hits</td>
                                    <td className="setting-checkbox">
                                        <label className="check-setting">
                                            <input name="betHits" onChange={changeSoundSetting} checked={soundSettings.betHits} type="checkbox"/>
                                            <span></span>
                                        </label>
                                    ...
                                    <td>
                                        {
                                            soundSettings.betHits ? 'On' : 'Off'
                                        }
                                    </td>
                                </tr>
                                <tr>
                                    <td className="setting-title">Asteroid</td>
                                    <td className="setting-checkbox">
                                        <label className="check-setting">
                                            <input name="asteroid" onChange={changeSoundSetting} checked={soundSettings.asteroid} type="checkbox"/>
                                            <span></span>
                                        </label>
                                    ...
                                    <td>
                                        {
                                            soundSettings.asteroid ? 'On' : 'Off'
                                        }
                                    </td>
                                </tr>
                                <tr>
                                    <td className="setting-title">Cash Out</td>
                                    <td className="setting-checkbox">
                                        <label className="check-setting">
                                            <input name="cashOut" onChange={changeSoundSetting} checked={soundSettings.cashOut} type="checkbox"/>
                                            <span></span>
                                        </label>
                                    ...
                                    <td>
                                        {
                                            soundSettings.cashOut ? 'On' : 'Off'
                                        }
                                    </td>
                                </tr>
                                <tr>
                                    <td className="setting-title">Explosion</td>
                                    <td className="setting-checkbox">
                                        <label className="check-setting">
                                            <input name="explosion" onChange={changeSoundSetting} checked={soundSettings.explosion} type="checkbox"/>
                                            <span></span>
                                        </label>
                                    ...
                                    <td>
                                        {
                                            soundSettings.explosion ? 'On' : 'Off'
                                        }
                                    </td>
                                </tr>
                                <tr>
                                    <td className="setting-title">All</td>
                                    <td className="setting-checkbox">
                                        <label className="check-setting">
                                            <input name="all" onChange={changeSoundSetting} checked={soundSettings.all} type="checkbox"/>
                                            <span></span>
                                        </label>
                            ...
                            <div className="volume">
                                ...
                                <form>
                                    <div className="volume-scroll mb-0">
